...
public class PostAssignmentPage {
	...
	public void  selectRequest (String Review,String ReviewerType,String year, String Request, String Reviewer) throws InterruptedException{
	...
	driver.manage().timeouts().implicitlyWait(20, TimeUnit.SECONDS);
	driver.findElement(fundingYear).sendKeys(year);
