...
public class FourComadReviewEditTest {
...
public void finalReviewerSubmitNote() throws InterruptedException{
	EditNotesPage notesPage = new EditNotesPage(driver);
	notesPage.fourEditReviewNotes();
...
public void usacReviewerSubmitNote() throws InterruptedException{
	EditNotesPage notesPage = new EditNotesPage(driver);
	notesPage.fourCompleteReviewNotes();
}
}